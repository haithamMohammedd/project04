...
<body>
    <div class="container my-5">
        ...
        @endif
        <form action="{{ route('courses.update',$course->id) }}" method="POST" enctype="multipart/form-data" class="mt-3">
            @csrf
            @method('put')
            <div class="mb-3">
                <label>Name</label>
            ...
            <div class="mb-3">
                ...
                <img width="80" src="{{ asset('uploads/'.$course->image) }}" alt="">
            </div>

            <div class="mb-3">
                <label>Description</label>
                <textarea name="description" placeholder="Description" class="form-control" rows="5">
                    {{ $course->description }}
                </textarea>
            </div>
